    ...
    <main role="main">
        <div class="container">
            <div class="text-center">
                <p class="lead text"><h2>KP-IF-06</h2></p>
            </div>
        </div>
        <div class="container">
            <div class="row">
                <div class="col">
                    <img class="center img-fluid" src="../assets/images/KP-IF-06.png" width="300" alt="Card image cap">
                </div>
                <div class="col">
                    <form method="post" action="{{route('kp-6.kp6') }}">
                        @csrf
                        <div class="form-group">
                            <div class="row">
                                <div class="col">
                                    ...
                                    <label for="pemlap">Pembimbing Lapangan</label>
                                    ...
                                    <label for="lokasiKp">Lokasi KP (Kab/Kota)</label>
